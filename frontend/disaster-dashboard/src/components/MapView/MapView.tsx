...
const SUGGESTED_QUERIES = [
  'How many major-damage buildings are there?',
  'How many major-damage buildings are on Uptown Park Boulevard?',
  'Show streets with major damage',
  'What made Hurricane Harvey so destructive?',
  'When did Hurricane Harvey happen?',
];
