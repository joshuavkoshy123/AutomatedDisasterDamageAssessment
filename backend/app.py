...
def get_stats(disaster_id: str | None = None):
    ...
    num_major_damage = 0
    num_severe_damage = 0
    return {"accuracy": accuracy, "num_no_damage": num_no_damage, "num_minor_damage": num_minor_damage, "num_major_damage": num_major_damage, "num_severe_damage": num_severe_damage}